...
export default function HeroShowcase(){
 ...
 return <>
  <style>{`
  /* DC HERO v4 — compact hero kept in normal document flow so the homepage below cannot be hidden underneath it. */
  ...
  .dc-showcase{position:relative;top:auto;left:auto;transform:none;z-index:20;margin:0 auto}
  .dc-showcase-inner{position:relative;min-height:470px;height:470px;overflow:hidden;border-radius:0 0 28px 28px;display:grid;grid-template-columns:42% 58%;transition:background .6s ease;box-shadow:0 18px 45px rgba(55,46,31,.10)}
  .dc-showcase-copy{padding:40px 32px 55px 54px;display:flex;flex-direction:column;justify-content:center;z-index:6}
  ...
  .dc-showcase-lead{font-size:18px;line-height:1.42;max-width:360px;margin:18px 0}
  ...
  .dc-orb{position:absolute;width:410px;height:410px;border-radius:50%;right:-60px;top:25px;opacity:.5;mix-blend-mode:screen;z-index:2}
  .dc-pack{position:absolute;right:18%;bottom:48px;width:164px;height:240px;border-radius:12px 12px 18px 18px;background:#191916;color:#fff;box-shadow:0 24px 40px #2b291d65;padding:16px;transform:rotate(-3deg);z-index:4}
  ...
  .dc-shaker{position:absolute;right:5%;bottom:32px;width:78px;height:178px;border-radius:16px 16px 28px 28px;background:#252520;color:#fff;box-shadow:0 20px 30px #2226;text-align:center;padding-top:17px;font-family:'Space Grotesk';font-size:22px;z-index:5}.dc-shaker span{display:block;font-size:8px;line-height:1.1;margin-top:32px;color:#c7e33a}
  .dc-scene{position:absolute;left:28px;bottom:28px;width:96px;height:52px;border-radius:0 0 52px 52px;background:#fffdf8cc;box-shadow:0 12px 25px #493b2530;display:flex;align-items:center;justify-content:center;font-size:12px;z-index:4}.dc-leaf{position:absolute;left:92px;bottom:58px;font-size:50px;color:#78932b;transform:rotate(-25deg);z-index:4}
  .dc-strip{position:absolute;bottom:0;left:0;right:0;height:50px;background:#fffdf9e8;backdrop-filter:blur(10px);display:flex;align-items:center;justify-content:space-around;z-index:7;font-size:9px;font-weight:800}
  ...
  @media(max-width:760px){
    main > section.hero{display:none}.dc-showcase{width:100%;margin:0}.dc-showcase-inner{min-height:430px;height:430px;display:block;border-radius:0 0 22px 22px}
    ...
    .dc-showcase-copy{position:absolute;left:0;right:0;top:0;padding:40px 22px 0;z-index:6;color:#fff;display:block}
    .dc-showcase-copy .eyebrow{color:#dce98c;text-shadow:0 1px 8px #0005}.dc-showcase h1{font-size:51px;line-height:.86;text-shadow:0 2px 15px #0007}.dc-showcase h1 em{color:#c9e43a}.dc-showcase-lead{font-size:15px;line-height:1.3;max-width:330px;margin:14px 0 12px;text-shadow:0 1px 8px #0007}
    .dc-showcase-copy .btn.primary{background:#1b1b17;color:#fff}.dc-showcase-copy .btn.outline{border-color:#fff;background:#fff;color:#1b1b17}.dc-showcase-copy .btn{padding:10px 13px!important;font-size:9px}
    .dc-pack{right:20%;bottom:54px;width:122px;height:180px;padding:12px}.dc-pack-logo{font-size:21px}.dc-pack-name{margin-top:61px;font-size:16px}.dc-shaker{right:5%;bottom:39px;width:60px;height:136px;font-size:18px}.dc-shaker span{font-size:6.5px;margin-top:25px}.dc-scene{left:8px;bottom:40px;width:70px;height:39px}.dc-leaf{left:48px;bottom:61px;font-size:36px}
    .dc-strip{height:40px;font-size:7px}.dc-strip span:nth-child(3){display:none}.dc-dots{right:20px;top:19px}.dc-slide-label{top:17px;left:16px;font-size:6.5px;padding:7px 10px}.dc-arrow{top:50%;width:32px;height:32px;font-size:17px}.dc-prev{left:9px}.dc-next{right:9px}
  }
  ...
  `}</style>
  <section className="wrap dc-showcase" id="visual-hero"><div className="dc-showcase-inner" style={{background:s.bg}}>
